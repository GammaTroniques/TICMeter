...
{   
    ...
    {10,  "Point n courbe injectée",         "CCAIN",       &linky.data.std.CCAIN,         UINT32_TIME,  MODE_STANDARD,   STATIC_VALUE,  NONE_CLASS,  "",                                    0x0000, 0x0000,  },
    {11,  "Point n-1 courbe injectée",       "CCAIN-1",     &linky.data.std.CCAIN_1,       UINT32_TIME,  MODE_STANDARD,   STATIC_VALUE,  NONE_CLASS,  "",                                    0x0000, 0x0000,  },

    {12,  "Tension moyenne Phase 1",         "UMOY1",       &linky.data.std.UMOY1,         UINT32_TIME,  MODE_STANDARD,   STATIC_VALUE,  TENSION,     "",                                    0x0B04, 0x0511,  },
    {13,  "Tension moyenne Phase 2",         "UMOY2",       &linky.data.std.UMOY2,         UINT32_TIME,  MODE_STANDARD,   STATIC_VALUE,  TENSION,     "",                                    0x0B04, 0x0911,  },
    {14,  "Tension moyenne Phase 3",         "UMOY3",       &linky.data.std.UMOY3,         UINT32_TIME,  MODE_STANDARD,   STATIC_VALUE,  TENSION,     "",                                    0x0B04, 0x0A11,  },

    {15,  "Registre de Statuts",             "STGE",        &linky.data.std.STGE,          STRING,       MODE_STANDARD,   STATIC_VALUE,  NONE_CLASS,  "mdi:state-machine",                 0x0000, 0x0000,  },

    {16,  "Début Pointe Mobile 1",           "DPM1",        &linky.data.std.DPM1,          UINT32_TIME,  MODE_STANDARD,   STATIC_VALUE,  NONE_CLASS,  "",                                    0x0000, 0x0000,  },
    {17,  "Fin Pointe Mobile 1",             "FPM1",        &linky.data.std.FPM1,          UINT32_TIME,  MODE_STANDARD,   STATIC_VALUE,  NONE_CLASS,  "",                                    0x0000, 0x0000,  },
    {18,  "Début Pointe Mobile 2",           "DPM2",        &linky.data.std.DPM2,          UINT32_TIME,  MODE_STANDARD,   STATIC_VALUE,  NONE_CLASS,  "",                                    0x0000, 0x0000,  },
    {19,  "Fin Pointe Mobile 2",             "FPM2",        &linky.data.std.FPM2,          UINT32_TIME,  MODE_STANDARD,   STATIC_VALUE,  NONE_CLASS,  "",                                    0x0000, 0x0000,  },
    {20,  "Début Pointe Mobile 3",           "DPM3",        &linky.data.std.DPM3,          UINT32_TIME,  MODE_STANDARD,   STATIC_VALUE,  NONE_CLASS,  "",                                    0x0000, 0x0000,  },
    ...
    {24,  "N° jours en cours fournisseur",   "NJOURF",      &linky.data.std.NJOURF,        STRING,       MODE_STANDARD,   STATIC_VALUE,  NONE_CLASS,  "",                                    0x0000, 0x0000,  },
    {25,  "N° prochain jour fournisseur",    "NJOURF+1",    &linky.data.std.NJOURF_1,      STRING,       MODE_STANDARD,   STATIC_VALUE,  NONE_CLASS,  "",                                    0x0000, 0x0000,  },
    {26,  "Profil du prochain jour",         "PJOURF+1",    &linky.data.std.MSG2,          STRING,       MODE_STANDARD,   STATIC_VALUE,  NONE_CLASS,  "mdi:sun-clock",                     0x0000, 0x0000,  },
